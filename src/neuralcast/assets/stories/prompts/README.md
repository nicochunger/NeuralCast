...
- `schedule_system.md`: contrato de sistema para generacion de grilla semanal.
- `schedule_user.md`: plantilla de prompt usuario para planificacion semanal con template diario fijo.

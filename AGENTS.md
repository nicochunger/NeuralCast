...
Additional rule for story injector/scheduler edits:
- Whenever a requested change modifies `src/neuralcast/pipelines/story_injector.py` or `src/neuralcast/pipelines/schedule_generator.py`, automatically run the full 3-step VPS redeploy procedure after finishing the code change, unless explicitly told not to deploy.
